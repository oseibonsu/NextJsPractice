...
function Books(props) {
  console.log(props);
  console.log('goodbye');
  var router = Object(next_router__WEBPACK_IMPORTED_MODULE_2__["useRouter"])(); // const { data } = useSWR("/api/test", fetcher);
  // console.log(data);
...
//# sourceMappingURL=[id].js.fdb1eda06a7b080436bb.hot-update.js.map